...
function getDefaultAnalysisReport() {
  return {
    ...
    skill_radar: [
      { skill: "理论素养", value: 0, max_value: 100, level: "beginner", progress: 0, category: "理论素养" },
      { skill: "逻辑思维", value: 0, max_value: 100, level: "beginner", progress: 0, category: "逻辑思维" },
      { skill: "实操应用", value: 0, max_value: 100, level: "beginner", progress: 0, category: "实操应用" },
      { skill: "创新思维", value: 0, max_value: 100, level: "beginner", progress: 0, category: "创新思维" },
      { skill: "沟通表达", value: 0, max_value: 100, level: "beginner", progress: 0, category: "沟通表达" },
    ],
    learning_trends: [],
