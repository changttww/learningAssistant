  ...
  <div class="login-container">
    <div class="login-card">
      ...
      <div class="login-header">
        <div class="logo">
          <iconify-icon icon="mdi:school" width="40" height="40" class="text-blue-600"></iconify-icon>
        </div>
      ...
      <form @submit.prevent="handleLogin" class="login-form">
        <div class="form-group">
          ...
          <div class="input-wrapper">
            <iconify-icon icon="mdi:account" width="20" height="20" class="input-icon"></iconify-icon>
            <input
              id="username"
        ...
        <div class="form-group">
          ...
          <div class="input-wrapper">
            <iconify-icon icon="mdi:lock" width="20" height="20" class="input-icon"></iconify-icon>
            <input
              id="password"
