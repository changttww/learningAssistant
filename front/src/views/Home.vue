      ...
      <div class="flex flex-col md:flex-row items-center md:items-start gap-4">
        ...
        <div class="flex-1">
          <div class="flex flex-col md:flex-row md:items-center gap-3">
            ...
            <div class="flex items-center gap-2">
              <div class="bg-blue-100 text-blue-800 px-2 py-1 rounded-full text-xs font-medium">技术项目经理</div>
          ...
          <p class="text-gray-600 mt-2 text-sm">专注于教育科技领域，热衷于学习新技术，致力于打造高效的学习工具。</p>
          <div class="mt-3 flex flex-wrap gap-3 text-sm">
            <div class="flex items-center gap-1">
              <iconify-icon icon="mdi:school" width="16" height="16" class="text-gray-600"></iconify-icon>
              <span>北京大学 计算机科学与技术</span>
            </div>
            <div class="flex items-center gap-1">
              <iconify-icon icon="mdi:map-marker" width="16" height="16" class="text-gray-600"></iconify-icon>
              <span>北京市</span>
            </div>
            <div class="flex items-center gap-1">
              <iconify-icon icon="mdi:account-group" width="16" height="16" class="text-gray-600"></iconify-icon>
              <span>已加入3个学习小组</span>
            </div>
          </div>
          <div class="mt-3 flex gap-2">
            <button class="bg-[#2D5BFF] text-white font-medium py-1.5 px-3 rounded-lg text-xs hover:bg-opacity-90 transition-colors flex items-center gap-1">
              <iconify-icon icon="mdi:pencil" width="14" height="14"></iconify-icon>
              编辑个人资料
            </button>
            <button class="bg-gray-100 text-gray-700 font-medium py-1.5 px-3 rounded-lg text-xs hover:bg-gray-200 transition-colors flex items-center gap-1">
              <iconify-icon icon="mdi:share" width="14" height="14"></iconify-icon>
              分享主页
            </button>
          </div>
        </div>
        <div class="md:text-right">
          <div class="flex flex-col items-center md:items-end">
            <div class="bg-blue-50 text-blue-800 px-2 py-1 rounded-full text-sm font-medium">
              学霸 Lv.4
            </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-3 mb-4">
        <div class="stat-card bg-blue-50 p-4">
          ...
          <div class="text-xs text-green-600 mt-1 flex items-center">
            <iconify-icon icon="mdi:trending-up" width="12" height="12" class="mr-1"></iconify-icon>
            较上月增长 15%
          </div>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div class="card p-6">
          <div class="flex justify-between items-center mb-4">
            ...
            <router-link to="/personal-tasks" class="text-blue-600 hover:underline text-sm">查看全部</router-link>
          </div>
          <div class="space-y-3">
            <div v-if="todayTasks.length === 0" class="text-gray-500 text-center py-8">
              今日暂无任务
            </div>
            <div 
        ...
        <div class="card p-6">
          <div class="flex justify-between items-center mb-4">
            ...
            <select class="bg-gray-50 border border-gray-300 text-gray-700 text-sm rounded-lg focus:ring-blue-500 py-1.5 px-3">
        ...
        <div class="space-y-6">
          ...
          <div class="card">
            <div class="flex justify-between items-center mb-4">
              ...
              <button class="text-blue-600 hover:underline text-sm">自定义</button>
            </div>
...
export default {
  ...
  methods: {
    ...
    initCharts() {
        ...
        series: [
          {
            ...
            areaStyle: {
              color: {
                ...
                y2: 1,
                colorStops: [{
                  offset: 0, color: 'rgba(45,91,255,0.2)'
                }, {
      ...
      // 知识点分布图
      const knowledgeDistributionChart = echarts.init(this.$refs.knowledgeDistributionChart)
        ...
        series: [
          {
            ...
            data: [
              { value: 35, name: '前端技术', itemStyle: { color: '#2D5BFF' } },
              { value: 20, name: '后端开发', itemStyle: { color: '#34C759' } },
              { value: 15, name: '数据分析', itemStyle: { color: '#FF9500' } },
              { value: 25, name: '项目管理', itemStyle: { color: '#AF52DE' } },
